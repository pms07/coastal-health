...
export const _postTitles = (index: number) =>
  [
    'Will meditation help you get our from the rat race?',
    'Is climate impacting our planet?',
    'What are sign of being unhealthy?',
    'How to identify sea food contamination?',
    
  ][index];

export const _description = (index: number) =>
  [
    'Meditation can be a powerful tool for helping you step out of the "rat race," but it depends on how you define...',
    'climate change is significantly impacting our planet, and the evidence is visible in various ways. Human activities...',
    'Signs of being unhealthy can manifest physically, mentally, and emotionally. Recognizing these signs early can help...',
    'Identifying seafood contamination is crucial for ensuring food safety and protecting health. Contaminated seafood...',
  ][index];
